...
corrplot(correlacion, method = "shade", shade.col = NA, tl.col = "black", tl.srt = 50, addCoef.col = "black")
```
...
Si se quisiera ver cuáles son las dimensiones de los diamantes que más se repiten se podría realizar un gráfico (scatter plot) de tres dimensiones con el conjunto de variables c(x,y,z), en donde en aquellos puntos del gráfico que presenten una mayor concentración de datos representarían cuáles son las dimensiones más comunes para este set de datos. 