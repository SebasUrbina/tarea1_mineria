...
ggplot(atacama_2, aes(x = reorder(concepto, suma), y = suma)) +
          ...
          coord_flip()+
          ggtitle(label = "Top-10 palabras de la colección Atacama")+
          labs(x="Frecuencia", y="Concepto")
...
ggplot(coquimbo_2, aes(x = reorder(concepto, suma), y = suma)) +
          geom_bar(stat = "identity") + 
          coord_flip()+
          ggtitle(label = "Top-10 palabras de la colección Coquimbo")+
          labs(x="Frecuencia", y="Concepto")
...
ggplot(metropolitana_2, aes(x = reorder(concepto, suma), y = suma)) +
          geom_bar(stat = "identity") + 
          coord_flip()+
          ggtitle(label = "Top-10 palabras de la colección metropolitana")+
          labs(x="Frecuencia", y="Concepto")
