...
Nosotros Nicolás Herrera y , declaramos que realizamos de manera grupal los pasos de la presente actividad. También declaramos no incurrir en copia, ni compartir nuestras respuestas con otras personas ni con otros grupos. Por lo que, ratificamos que las respuestas son de nuestra propia confección y reflejan nuestro propio conocimiento.
...
```{r}
#Sumamos todas las columnas, y luego ordenamos
sort(colSums(data_tf[,2:ncol(data_tf)]))[1:10]
